...
export const name = 'client-ui-appearance-invariant'
/** Service required before the companion can reserve package ownership. */
export const inject = ['invariants']

/**
 * No runtime invariant: the settings seam validates and publishes the durable
 * appearance section, the wallpaper route answers from that same section on
 * every request, and slot conflicts fail loud in the slot core. The local
